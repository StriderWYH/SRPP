...
def main():
    ...
    model = SAC("MlpPolicy", env, learning_starts = 4000, batch_size=100,learning_rate= 1e-3,ent_coef='auto_0.2',policy_kwargs =policy_kwargs,
                train_freq = (30,"step"),gradient_steps=-1,target_update_interval=1,verbose=1, tensorboard_log="./src/SRPP/scripts/logs/sac_Franka_data/",
